...
st.sidebar.markdown(
    """
    <div style="text-align: center;">
     <a href="mailto:santoshrottayyanavar81@gmail.com" target="blank">
            <img src="https://cdn-icons-png.flaticon.com/512/561/561127.png" width="30" style="margin: 0 10px;">
        </a>
        <a href="https://www.linkedin.com/in/santosh-rottayyanavar-/" target="_blank">
            <img src="https://cdn-icons-png.flaticon.com/512/174/174857.png" width="30" style="margin: 0 10px;">
        </a>
        <a href="https://github.com/SantoshRottayyanavar" target="_blank">
...
with col2:
    ...
    #https://png.pngtree.com/background/20210715/original/pngtree-blue-gradient-watercolor-background-picture-image_1284318.jpg